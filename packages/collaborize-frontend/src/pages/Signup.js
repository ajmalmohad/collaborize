  ...
  return (
    <div className="Signup">
      <div className="content">
        ...
        <div className="form">
          <h1>
            Create<span className="continue"> new account</span>
            <span className="dot">.</span>
          </h1>
          <div className="redirect">
            <p className="label">Already a user?</p>
            <Link to="/login">
              <p>Login</p>
            </Link>
          </div>
          ...
          <TextField
            ...
            action={(e) => handleChange(e, "password")}
